...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENT = "application/dobbscoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/dobbscoin-paymentack";
