...
public class MainNetParams extends AbstractBitcoinNetParams {
    public MainNetParams() {
        ...
        port = 19985;
        packetMagic = 0xa0fb1783L;
        bip32HeaderPub = 0x0488B21E; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x0488ADE4; //The 4 byte header that serializes in base58 to "xprv"

        genesisBlock.setDifficultyTarget(0x1e0ffff0L);//this again not fit with dobbs merkle root, So, i put it manually.(merkle)
        genesisBlock.setTime(1389086657L);
        ...
        // genesisHash = new Sha256Hash (genesisHash);
        checkState(genesisHash.equals("6d2d7d525900712451b9697d0b5b2304ebae6efb349540da445bf575c0159969"),
                genesisHash);
        ...
        httpSeeds = new HttpDiscovery.Details[] {
             ...
             /*   new HttpDiscovery.Details(
                ...
                new HttpDiscovery.Details(
                        ...
                        URI.create("http://httpseed.dobbscoin.schildbach.de/peers")
                )*/
        };
