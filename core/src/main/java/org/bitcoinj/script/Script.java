 ...
 *
 * <p>dobbscoin transactions don't specify what they do directly. Instead <a href="https://en.dobbscoin.it/wiki/Script">a
...
public class Script {
     ...
     * The concept of a "from address" isn't well defined in dobbscoin and you should not assume the sender of a
     ...
     * logic is defined by <a href="https://github.com/dobbscoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a>.</p>
     *
