 ...
 * representations of dobbscoin monetary values.
 *
 ...
 * represents a dobbscoin monetary value.  Some of the features offered for doing this
 * are: <ol>
 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either dobbscoin, millicoin
 ...
 * locale, a value of one dobbscoin might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 BTC</code>, or one dobbscoin, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-dobbscoin value:
 *
 * <blockquote><pre>
 ...
 * <h3>Formatting</h3>
 *
 * <p>You format a dobbscoin monetary value by passing it to the {@link BtcFormat#format(Object)}
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a dobbscoin monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a dobbscoin value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a dobbscoin value as a number and possibly a units indicator to a
     ...
     * is the size of the decimal-place shift between the given dobbscoin-value denominated in
    ...
    /**
     * Takes a dobbscoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a dobbscoin quantity of any type the
    ...
    /**
      * Parse a <code>String</code> representation of a dobbscoin monetary value.  Returns a
    ...
    /** Parse a <code>String</code> representation of a dobbscoin monetary value.  If this
