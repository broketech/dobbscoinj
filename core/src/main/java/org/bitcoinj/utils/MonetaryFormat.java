...
public final class MonetaryFormat {
    ...
    /** Currency code for base 1 dobbscoin. */
    public static final String CODE_BTC = "BOB";
    /** Currency code for base 1/1000 dobbscoin. */
    public static final String CODE_MBTC = "mBOB";
    /** Currency code for base 1/1000000 dobbscoin. */
    public static final String CODE_UBTC = "µBOB";
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for dobbscoin
