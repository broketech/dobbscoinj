...
/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a dobbscoin chain.</p>
 *
...
public abstract class NetworkParameters implements Serializable {
     ...
     */
    public static final byte[] SATOSHI_KEY = Utils.HEX.decode("");//dobbs have invalid satoshi key

    //048D0BCFA9D2B74DE677EBDC9A369C398D9A4CBFCF7F8873E17EAAAE1CD340D127E871CAA0CD9F58CBB31A6D439BBA26559B6B5F03F6A309CD3C962694A8DA2F3E
    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_MAINNET = "org.dobbscoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.dobbscoin.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.dobbscoin.regtest";
    /** Unit test network. */
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Utils.HEX.decode
                    ("04ffff001d0104454e592054696d65732030352f4f63742f32303131205374657665204a6f62732c204170706c65927320566973696f6e6172792c2044696573206174203536");
            t.addInput(new TransactionInput(n, t, bytes));
            ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            Script.writeBytes(scriptPubKeyBytes, Utils.HEX.decode
                    ("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f"));
            scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
            t.addOutput(new TransactionOutput(n, t, (FIFTY_COINS.divide(50)), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.//5468652054696d65732030332f4a616e2f32303039204368616e63656c6c6f72206f6e206272696e6b206f66207365636f6e64206261696c6f757420666f722062616e6b73
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all dobbscoin implemenetations. For a
     ...
     * test and main dobbscoin networks use 2 weeks (1209600 seconds).
     */
    ...
    /** How many blocks pass between difficulty adjustment periods. dobbscoin standardises this to be 2015. */
    ...
    /**
     * Scheme part for URIs, for example "dobbscoin".
     */
    public abstract String getUriScheme();

    /**
     * Returns whether this network has a maximum number of coins (finite supply) or
     * not. Always returns true for dobbscoin, but exists to be overriden for other
     * networks.
     */
