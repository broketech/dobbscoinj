...
/**
 * <p>This command is supported only by <a href="http://github.com/bitcoinxt/bitcoinxt">dobbscoin XT</a> nodes, which
 ...
 * <a href="https://github.com/dobbscoin/bips/blob/master/bip-0065.mediawiki">BIP 65</a> for more information on this
 * message.</p>
 *
 * <p>Note that this message does not let you query the UTXO set by address, script or any other criteria. The
 * reason is that dobbscoin nodes don't calculate the necessary database indexes to answer such queries, to save
