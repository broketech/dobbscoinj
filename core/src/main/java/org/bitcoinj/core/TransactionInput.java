...
public class TransactionInput extends ChildMessage implements Serializable {
     ...
     * "from address" is not well defined in dobbscoin and you should not assume that senders of a transaction can
     ...
     * in nodes memory pools if the existing version is time locked. See the Contracts page on the dobbscoin wiki for
     ...
     * The "IsStandard" rules control whether the default dobbscoin Core client blocks relay of a tx / refuses to mine it,
