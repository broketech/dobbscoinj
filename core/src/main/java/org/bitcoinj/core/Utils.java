...
/**
 * A collection of various utility methods that are helpful for working with the dobbscoin protocol.
 * To enable debug logging from the library, run with -Dbitcoinj.logging=true on your command line.
 */
public class Utils {

    /** The string that prefixes all text messages signed using dobbscoin keys. */
    public static final String BITCOIN_SIGNED_MESSAGE_HEADER = "dobbscoin Signed Message:\n";
     ...
     *
     * <p>dobbscoin only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
     ...
     *
     * <tt><p>[24] "dobbscoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
