...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * <a href="https://github.com/dobbscoin/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
    ...
    /**
     * When true (the default), PeerGroup will attempt to connect to a dobbscoin node running on localhost before
