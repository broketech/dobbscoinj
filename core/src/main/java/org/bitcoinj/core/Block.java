...
public class Block extends Message {
    ...
    public static final long EASIEST_DIFFICULTY_TARGET = 0x207fFFFFL;//this also need to be change
    ...
    Block(NetworkParameters params) {
        ...
        version = 1;
        difficultyTarget = 0x1e0ffff0L; //0x1d07fff8L;
     ...
     * The inflation of dobbscoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
    ...
    public Sha256Hash getMerkleRoot() {
        ...
        if (merkleRoot == null) {
            ...
            unCacheHeader();
            merkleRoot = new Sha256Hash("21e66ff8b6f14eb3fa0edf35dc93440a751fdddb421965c88029ad0048d98ca1");
        }
        return merkleRoot;
    }
    ...
    /** Returns the version of the block data structure as defined by the dobbscoin protocol. */
     ...
     * the difficulty value reported by the dobbscoin "getdifficulty" RPC that you may see on various block explorers.
     ...
     * <a href="https://github.com/dobbscoin/bips/blob/master/bip-0034.mediawiki">BIP34: Height in Coinbase</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/dobbscoin/bips/blob/master/bip-0066.mediawiki">BIP66: Strict DER signatures</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/dobbscoin/bips/blob/master/bip-0065.mediawiki">BIP65: OP_CHECKLOCKTIMEVERIFY</a>.
     */
