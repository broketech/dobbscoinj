 ...
 * dobbscoin system, with the downside being a large cost in system resources. Fully verifying means all unspent
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://github.com/dobbscoin/bips/blob/master/bip-0030.mediawiki
