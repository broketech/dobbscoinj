...
/**
 * <p>A Message is a data structure that can be serialized/deserialized using both the dobbscoin proprietary serialization
...
public abstract class Message implements Serializable {
     ...
     * @param protocolVersion dobbscoin protocol version.
    ...
    // These methods handle the serialization/deserialization using the custom dobbscoin protocol.
    ...
    /**
     * Serialize this message to a byte array that conforms to the dobbscoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the dobbscoin wire format.
     *
     * @param stream
     * @throws IOException
     */
