...
public class TransactionOutput extends ChildMessage implements Serializable {
    ...
    // These fields are Java serialized but not dobbscoin serialized. They are used for tracking purposes in our wallet
    ...
    /**
     * <p>If the output script pays to an address as in <a href="https://dobbscoin.org/en/developer-guide#term-p2pkh">
     ...
     * the redeem script.</p>
     *
     * <p>P2SH is described by <a href="https://github.com/dobbscoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a> and
     * <a href="https://dobbscoin.org/en/developer-guide#p2sh-scripts">documented in the dobbscoin Developer Guide</a>.</p>
     *
     * @param networkParameters needed to specify an address
     ...
     * consume more than a third of its value in fees is not something the dobbscoin system wants to deal with right now,
