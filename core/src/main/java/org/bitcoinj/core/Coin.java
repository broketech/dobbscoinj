...
/**
 * Represents a monetary dobbscoin value. This class is immutable.
 */
public final class Coin implements Monetary, Comparable<Coin>, Serializable {

    /**
     * Number of decimals for one dobbscoin. This constant is useful for quick adapting to other coins because a lot of
     * constants derive from it.
     */
    public static final int SMALLEST_UNIT_EXPONENT = 8;

    /**
     * The number of satoshis equal to one dobbscoin.
     */
    ...
    /**
     * A satoshi is the smallest unit that can be transferred. 100 million of them fit into a dobbscoin.
     */
