 ...
 *
 * <p>ECKey also provides access to dobbscoin Core compatible text message signing, as accessible via the UI or JSON-RPC.
 ...
 * are encoded using ASN.1/DER inside the dobbscoin protocol.</p>
 *
...
public class ECKey implements EncryptableItem, Serializable {
    ...
    // The parameters of the secp256k1 curve that dobbscoin uses.
    ...
    /**
     * Construct an ECKey from an ASN.1 encoded private key. These are produced by OpenSSL and stored by the dobbscoin
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by the dobbscoin reference
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the dobbscoin protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * href="https://github.com/dobbscoin/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures">BIP62</a>.
         */
         ...
         * the same message. However, we dislike the ability to modify the bits of a dobbscoin transaction after it's
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the dobbscoin protocol, they are
    ...
    /**
     * Signs a text message using the standard dobbscoin messaging signing format and returns the signature as a base64
     * encoded string.
     *
    ...
    /**
     * Given an arbitrary piece of text and a dobbscoin-format message signature encoded in base64, returns an ECKey
     * containing the public key that was used to sign it. This can then be compared to the expected public key to
     * determine if the signature was correct. These sorts of signatures are compatible with the dobbscoin-Qt/bitcoind
     * format generated by signmessage/verifymessage RPCs and GUI menu options. They are intended for humans to verify
     * their communications with each other, hence the base64 format and the fact that the input is text.
     *
     * @param message Some piece of human readable text.
     * @param signatureBase64 The dobbscoin-format message signature in base64
