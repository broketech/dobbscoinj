...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
    ...
    private void processTxFromBestChain(Transaction tx, boolean forceAddToPool) throws VerificationException {
        ...
        if (isDeadCoinbase) {
            ...
            // we could. dobbscoin Core nodes on the network have deleted the dependent transactions from their mempools
    ...
    public static class SendResult {
        /** The dobbscoin transaction message that moves the money. */
    ...
    public static class SendRequest {
         ...
         * is how mining is incentivized in later years of the dobbscoin system when inflation drops. It also provides
     ...
     *
     * @param address The dobbscoin address to send the money to.
     ...
     * @throws ExceededMaxTransactionSize if the resultant transaction is too big for dobbscoin to process (try breaking up the amounts of value)
     */
     ...
     * sending transactions to the dobbscoin network by default. Some sendCoins methods let you specify a broadcaster
