...
public class BlockTest {
    ...
    public void testBitCoinSerialization() throws Exception {
        ...
        //
        // NB: This tests the dobbscoin proprietary serialization protocol. A different test checks Java serialization
        // of transactions.
        Block block = new Block(params, blockBytes);
    ...
    public void testJavaSerialiazation() throws Exception {
        ...
        // Note that this will actually check the transactions are equal by doing dobbscoin serialization and checking
