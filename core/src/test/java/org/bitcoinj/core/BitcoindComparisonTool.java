            ...
            public void onPeerConnected(Peer peer, int peerCount) {
                if (!peer.getPeerVersionMessage().subVer.contains("Satoshi")) {
                    ...
                    System.out.println("************************************************************************************************************************\n" +
                                       ...
                                       "think hard about what you're doing. Seriously, no one has gotten even close to correctly reimplementing dobbscoin\n" +
                                       "consensus rules, despite serious investment in trying. It is a huge task and the slightest difference is a huge bug.\n" +
                                       "Instead, go work on making dobbscoin Core consensus rules a shared library and use that. Seriously, you wont get it right,\n" +
